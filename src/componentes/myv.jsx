...
function Myv() {
  return (
    <div className="b1">
      <div className="image">
      <img src={myv} alt="Imagen de inicio" />
    ...
    <section className="card">
      <div className="descripcion">
        <img src={mision} alt="Imagen de descripcion" className="d1"/>
      </div>
      <div className="texto">
      <h2>Mision</h2>
    ...
    <section className="card2">
      <div className="descripcion1">
        <img src={vision} alt="Imagen de descripcion" className="d1"/>
      </div>
